...
class PlaceSymbolBodyState extends State<PlaceSymbolBody> {
  ...
  static final LatLng center = const LatLng(16.065423, 108.188714);

  MapboxMapController? controller;
  int _symbolCount = 0;
  Symbol? _selectedSymbol;
  bool _iconAllowOverlap = true;
  ...
  void _onStyleLoaded() {
    try {
      ...
      final _stop1 = WayPoint(
          name: "Way Point 2", latitude: 16.065423, longitude: 108.188714);
      final _origin = WayPoint(
          name: "Way Point 1", latitude: 16.059761, longitude: 108.211771);
  ...
  void _add(String iconImage) {
    try {
      controller!.selectedRoute(0, EdgeInsets.only(bottom: 800, top: 10));
